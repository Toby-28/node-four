...
;(function (h) {
      ...
      if (0 !== i.length) {
        ...
        for (j = j ? 0 : g; j < f; j++) {
          ...
          if (0 !== e) {
            var G = d[c % e]
            q._sRowStripe != G &&
              (h(s).removeClass(q._sRowStripe).addClass(G), (q._sRowStripe = G))
          }
  ...
  l.defaults = {
    ...
    oLanguage: {
      ...
      sEmptyTable: 'Hiç hili maglumat ýüklenmedi',
      sInfo: 'Umumy sany: _TOTAL_ | şu sahypada: _END_',
      sInfoEmpty: 'Umumy sany: 0',
      sInfoFiltered: '(_MAX_ sanysyndan filterlendi)',
      sInfoPostFix: '',
      sDecimal: '',
      sThousands: ',',
      sLengthMenu: 'Her sahypada _MENU_',
      sLoadingRecords: 'Ýüklenýär...',
      sProcessing: 'Proses gidýär...',
      sSearch: 'Gözle:',
      sSearchPlaceholder: '',
      sUrl: '',
      sZeroRecords: 'Gabat gelýän maglumat tapylmady',
    },
